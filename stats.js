  ...
  const ACHIEVEMENTS_SECTIONS = [
    ...
    },
    {
      ...
      items: [
        ...
        'Смотреть Prehistoric Planet (Apple TV+, BBC Studios)',
        'Смотреть Алладина',
    ...
    },
    {
      ...
      items: [
        ...
        'Дойти до рекорда в 100 без показа следующего символа',
        'Дойти до средней в 100 без показа следующего символа',
        'Дойти до рекорда в 100 без подсказки слова',
        'Дойти до средней в 100 без подсказки слова',
      ],
    },
    {
      title: 'Читать',
